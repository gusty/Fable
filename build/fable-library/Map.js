...
export function FSharpMap__ComputeHashCode(this$) {
    ...
    try {
        while (enumerator["System.Collections.IEnumerator.MoveNext"]()) {
            ...
            const activePatternResult4073 = forLoopVar;
            res = combineHash(res, structuralHash(activePatternResult4073[0]));
            res = combineHash(res, structuralHash(activePatternResult4073[1]));
        }
    }
    finally {
        enumerator.Dispose();
